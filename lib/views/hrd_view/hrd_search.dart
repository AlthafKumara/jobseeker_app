...
import 'package:jobseeker_app/widgets/hrd_listview_dashboard.dart';
              ...
              children: [
                ...
                if (_isSearching)
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        "${_searchResults.length} Job(s) Found",
                        style: const TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.w600,
                            fontFamily: "Lato"),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      HrdListViewDashboard(limitItems: false),
                    ],
                  ),
              ],
            ),
